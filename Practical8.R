...
#Question 1
sample_text <- 'I am a student from the University of Pretoria. I was born in Durban, South Africa and I have been a huge soccer fan for 9 years. I also have a passion for Philosophy and love talking about it and discovering more things about the field. Therefore, I am going to get a degree in Philosophy toimprove my chances of becoming a Philosophy professor. I have been working towards this goal for 4 years. I am currently enrolled in a PhD program. It is very difficult, but I am confident that it will be a good decision.'

pat11 <- 'Durban'
  
q11 <- str_extract(sample_text,pat11)
...
pat21 <- '[a-zA-Z0-9-_.]+@[a-zA-Z0-9-_.]+'
  
q21 <- str_extract_all(string,pat21, simplify = TRUE)


pat22 <- "\\w+\\.\\w+\\@\\w+\\.\\w+\\.\\w+|\\w+\\@\\w+\\.\\w+"
  
q22  <- str_match_all(string,pat22)[[1]]
